...
class PubRecTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @var \Mqtt\Protocol\Encoder\Packet\ControlPacket\PubRec
   */
  protected $object;
  ...
  protected function setUp() {
    $this->object = clone $this->___container->get(\Mqtt\Protocol\Encoder\Packet\ControlPacket\PubRec::class);
    $this->packet = clone $this->___container->get(\Mqtt\Protocol\Entity\Packet\PubRec::class);
  }
  ...
  public function testEncodesFrameProperly() {
    ...
    $this->object->encode($this->packet);
    $this->assertEquals(\Mqtt\Protocol\IPacketType::PUBREC, $this->object->get()->packetType);
    $this->assertEquals(\Mqtt\Protocol\IPacketReservedBits::FLAGS_PUBREC, $this->object->get()->flags->get());
