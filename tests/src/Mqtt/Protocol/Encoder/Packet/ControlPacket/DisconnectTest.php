...
class DisconnectTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @var \Mqtt\Protocol\Encoder\Packet\ControlPacket\Disconnect
   */
  protected $object;
  ...
  protected function setUp() {
    $this->object = clone $this->___container->get(\Mqtt\Protocol\Encoder\Packet\ControlPacket\Disconnect::class);
  ...
  public function testEncodesFrameProperly() {
    ...
    $this->assertEquals(\Mqtt\Protocol\IPacketReservedBits::FLAGS_DISCONNECT, $this->object->get()->flags->get());
