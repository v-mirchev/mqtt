...
class PubAckTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @var \Mqtt\Protocol\Decoder\Packet\ControlPacket\PubAck
   */
  protected $object;
  ...
  protected function setUp() {
    $this->object = clone $this->___container->get(\Mqtt\Protocol\Decoder\Packet\ControlPacket\PubAck::class);
  ...
  public function testInitialCleanState() {
    ...
    $this->assertEquals(\Mqtt\Protocol\IPacketType::PUBACK, $object->get()->getType());
  }
