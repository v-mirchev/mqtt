...
class PubRelTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @var \Mqtt\Protocol\Encoder\Packet\ControlPacket\PubRel
   */
  protected $object;
  ...
  protected function setUp() {
    $this->object = clone $this->___container->get(\Mqtt\Protocol\Encoder\Packet\ControlPacket\PubRel::class);
    $this->packet = clone $this->___container->get(\Mqtt\Protocol\Entity\Packet\PubRel::class);
  }
  ...
  public function testEncodesFrameProperly() {
    ...
    $this->object->encode($this->packet);
    $this->assertEquals(\Mqtt\Protocol\IPacketType::PUBREL, $this->object->get()->packetType);
    $this->assertEquals(\Mqtt\Protocol\IPacketReservedBits::FLAGS_PUBREL, $this->object->get()->flags->get());
