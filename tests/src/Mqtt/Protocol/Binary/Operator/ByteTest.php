...
class ByteTest extends \PHPUnit\Framework\TestCase {
  ...
  public function testGetSub() {
    ...
    $this->assertEquals(bindec('1111'), $this->object->getSub(0, 3));
    $this->object->set(bindec('1111 1010'));
    $this->assertEquals(bindec('1010'), $this->object->getSub(0, 3));

    $this->object->set(bindec('0000 0000'));
    $this->assertEquals(bindec('0000'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0000 0100'));
    $this->assertEquals(bindec('0001'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0000 1100'));
    $this->assertEquals(bindec('0011'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0001 1100'));
    $this->assertEquals(bindec('0111'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0011 1100'));
    $this->assertEquals(bindec('1111'), $this->object->getSub(2, 5));
    ...
    $this->assertEquals(bindec('1000'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0011 0000'));
    $this->assertEquals(bindec('1100'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0011 1000'));
    $this->assertEquals(bindec('1110'), $this->object->getSub(2, 5));
    $this->object->set(bindec('0011 1100'));
    $this->assertEquals(bindec('1111'), $this->object->getSub(2, 5));
